...
const About = () => {
  return (
    <div className="pt-20">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="space-y-8">
            <div className="bg-card p-8 rounded-2xl border border-border">
              <h3 className="text-2xl font-bold text-text-primary mb-4">The frustration</h3>
            ...
            <div className="bg-card p-8 rounded-2xl border border-border">
              <h3 className="text-2xl font-bold text-text-primary mb-4">The breakthrough</h3>
              <p className="text-text-secondary leading-relaxed mb-4">
            ...
            <div className="bg-card p-8 rounded-2xl border border-border">
              <h3 className="text-2xl font-bold text-text-primary mb-4">The commitment</h3>
              <p className="text-text-secondary leading-relaxed mb-4">
      ...
      <section className="py-24 lg:py-32 bg-gradient-to-b from-bg-primary to-[#0F1419]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-black text-text-light tracking-tight mb-8">
            We're just getting started
          </h2>
          <p className="text-xl text-text-muted-light leading-relaxed mb-8">
            Nexus² is live on thousands of websites, helping millions of visitors every month. 
            But we're nowhere near done.
          </p>
          <p className="text-lg text-text-muted-light leading-relaxed mb-12">
